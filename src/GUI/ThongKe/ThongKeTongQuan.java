...
import GUI.ThongKe.Support.CurveChart;
import GUI.ThongKe.Support.Formater;
import GUI.ThongKe.Support.ModelChart2;
...
public class ThongKeTongQuan extends JPanel {
    ...
    String[][] getSt = {
        {"Sản phẩm hiện có trong kho", "productt.svg", Integer.toString(SachDAO.getInstance().selectAll().size())},
    ...
    public ThongKeTongQuan() {
        this.dataset = new ThongKeBUS().getThongKe7NgayGanNhat();
        initComponent();
    ...
    private void initComponent() {
        ...
        new TableSorter().configureTableColumnSorter(tableThongKe, 0, TableSorter.DATE_COMPARATOR);
        new TableSorter().configureTableColumnSorter(tableThongKe, 1, TableSorter.VND_CURRENCY_COMPARATOR);
        new TableSorter().configureTableColumnSorter(tableThongKe, 2, TableSorter.VND_CURRENCY_COMPARATOR);
        new TableSorter().configureTableColumnSorter(tableThongKe, 3, TableSorter.VND_CURRENCY_COMPARATOR);
