 ...
 * @author Minnie
 */
public class NhanVienDialogUpdate extends JDialog{
    private JTextField txfMa, txfHo, txfTen, txfGioitinh, txfSdt,  txfTrangthai, txfNgaysinh;

    public NhanVienDialogUpdate(JFrame parent) {
        super(parent,"Danh mục sửa thông tin nhân viên", true);
        
        JPanel panel = new JPanel();
        panel.setLayout(new BorderLayout(10, 10));

        // Tiêu đề
        JLabel titleLabel = new JLabel("CHỈNH SỬA THÔNG TIN NHÂN VIÊN", SwingConstants.CENTER);
        ...
        ActionListener action=new NhanVienDialogUpdate_Controller(this);
