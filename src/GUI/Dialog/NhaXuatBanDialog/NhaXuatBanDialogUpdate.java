 ...
 * @author Hi
 */
public class NhaXuatBanDialogUpdate extends JDialog {
    private JTextField txTenNhaXuatBan, txMaNhaXuatBan, txDiaChi, txSDT, txEmail;
    private NhaXuatBanDialog nxbPanel;
    private JButton btnXacNhan, btnHuy;
    private NhaXuatBanDTO nhaxuatbanhientai; // Tạo biến để lấy đối tượng hiện tại đang chọn
    
    public NhaXuatBanDialogUpdate(JFrame parent, NhaXuatBanDialog nxbPanel, NhaXuatBanDTO nhaxuatban) {
        super(parent, "Sửa Nhà xuất bản", true);
        this.nxbPanel = nxbPanel;
        this.nhaxuatbanhientai = nhaxuatban; // Lưu lại đối tượng nhà xuất bản hiện tại
        setSize(500, 400);
        setResizable(false);
        ...
        // ======= Tiêu đề =======
        JLabel titleLabel = new JLabel("SỬA NHÀ XUẤT BẢN", SwingConstants.CENTER);
        ...
        JLabel lb_ma = new JLabel("Mã nhà xuất bản:");
        ...
        txMaNhaXuatBan = new JTextField(20);
        txTenNhaXuatBan = new JTextField(20);
        txDiaChi = new JTextField(20);
        txSDT = new JTextField(20);
        txEmail = new JTextField(20);
        txMaNhaXuatBan.setPreferredSize(new Dimension(200, 30));
        txMaNhaXuatBan.setEditable(false);
        txMaNhaXuatBan.setBackground(Color.lightGray);
        ...
        pn_input.add(txMaNhaXuatBan, gbc);
        ...
        txMaNhaXuatBan.setText(String.valueOf(nhaxuatban.getManxb()));
        txTenNhaXuatBan.setText(nhaxuatban.getTennxb());
        txDiaChi.setText(nhaxuatban.getDiachinxb());
        txSDT.setText(nhaxuatban.getSdt());
        txEmail.setText(nhaxuatban.getEmail());
    ...
    public void setController(NhaXuatBanDialogUpdate_Controller controller) {
