    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(sukien.equals("Lưu thông tin")){
            if (BDU.getTxfTensach().getText().isEmpty() || 
                BDU.getTxfManxb().getText().isEmpty() || 
                BDU.getTxfMatacgia().getText().isEmpty() || 
                BDU.getTxfMatheloai().getText().isEmpty() || 
                ...
                int maNXB = Integer.parseInt(BDU.getTxfManxb().getText());
                int maTG = Integer.parseInt(BDU.getTxfMatacgia().getText());
                int maTL = Integer.parseInt(BDU.getTxfMatheloai().getText());
