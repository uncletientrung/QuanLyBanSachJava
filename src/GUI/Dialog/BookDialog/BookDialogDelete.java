...
public class BookDialogDelete extends JDialog{
     ...
     public BookDialogDelete(JFrame parent,String masach) { // Truyền tham số masach vào để xóa  
        super(parent, "Danh mục xóa sách", true);
        this.masach=masach; // Phải viết sau super (Mọi hàm Constructor phải viết super trước rồi tới mấy cái cần làm)
        setSize(350,150);
        ...
        JLabel lbNotice= new JLabel("Bạn có chắn chắn muốn xóa sách này không!!");
