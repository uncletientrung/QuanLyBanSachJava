 ...
 * @author Hi
 */
public class NhaCungCapDialogUpdate extends JDialog{
    private JTextField txTenNhaCungCap,txMaNhaCungCap,txDiaChi,txSDT,txEmail;
    private NhaCungCapDialog  nccPanel;
    private JButton btnXacNhan, btnHuy;
    private NhaCungCapDTO nhacungcaphientai; // tao bien de lay doi tuong hien tai dang chon
    
    public NhaCungCapDialogUpdate(JFrame parent, NhaCungCapDialog  nccPanel,NhaCungCapDTO nhacungcap){
        super(parent, "Sửa Nhà cung cấp", true);
        this.nccPanel = nccPanel;
        this.nhacungcaphientai = nhacungcap; // Lưu lại đối tượng nhà cung cấp hiện tại
        setSize(500, 400);
        setResizable(false);
        ...
        // ======= Tiêu đề =======
        JLabel titleLabel = new JLabel("SỬA NHÀ CUNG CẤP", SwingConstants.CENTER);
        ...
        // Label Mã nhóm quyền
        JLabel lb_ma = new JLabel("Mã nhà cung cấp");
        ...
        txMaNhaCungCap= new JTextField(20);
        txTenNhaCungCap = new JTextField(20);
        txDiaChi= new JTextField(20);
        txSDT = new JTextField(20);
        txEmail = new JTextField(20);
        txMaNhaCungCap.setPreferredSize(new Dimension(200, 30));
        txMaNhaCungCap.setEditable(false);
        txMaNhaCungCap.setBackground(Color.lightGray);
        ...
        pn_input.add(txMaNhaCungCap, gbc);
        ...
        txMaNhaCungCap.setText(String.valueOf(nhacungcap.getMancc()));
        txTenNhaCungCap.setText(nhacungcap.getTenncc());
        txDiaChi.setText(nhacungcap.getDiachincc());
        txSDT.setText(nhacungcap.getSdt());
        txEmail.setText(nhacungcap.getEmail());
    ...
    public void setController(NhaCungCapDialogUpdate_Controller controller) {
